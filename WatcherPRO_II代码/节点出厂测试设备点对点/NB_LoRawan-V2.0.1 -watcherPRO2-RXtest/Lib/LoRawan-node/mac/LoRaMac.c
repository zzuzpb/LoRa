...
static void OnRadioTxDone( void )
{
   ...
   if( LoRaMacDeviceClass != CLASS_C )
    ...
    {
    	DEBUG(2, "IsRxWindowsEnabled is true\r\n");
...
//                else
				...
				sequenceCounterPrev = ( uint16_t )downLinkCounter; ///±£ÁôÉÏ´Î½ÓÊÕµ½µÄÖ¡ºÅ£ºÖ»½ÓÊÕÒ»¸öÖÕ¶ËÉè±¸ÊÇÕý³£µÄ
				...
				{      	
                	sequenceCounterPrev = ( uint16_t )downLinkCounter = 0;  
...
void OnRxWindow1TimerEvent( void )
{
    ...
    RxWindowSetup( (Channels[Channel].Frequency), datarate, bandwidth, symbTimeout, false );//false---trueÁ¬Ðø½ÓÊÕ
...
//		 RxWindowSetup( 340000000, datarate, bandwidth, symbTimeout, true );
