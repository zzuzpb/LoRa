...
Set_Gps_Ack_t Set_Gps_Ack = {false, false, false, false, false, 0, 0};
...
extern void PostPress(void);

void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart)
{
    if(huart->Instance==USART1)//如果是串口2
    {
        if(UART_RX_DATA1.aRxBuffer[0] == '\n')
		{
			UART_RX_DATA1.USART_TX_STATE = true;
            PostPress(  );
		}
		else
        {
            ...
            UART_RX_DATA1.rxtime = HAL_GetTick( );
