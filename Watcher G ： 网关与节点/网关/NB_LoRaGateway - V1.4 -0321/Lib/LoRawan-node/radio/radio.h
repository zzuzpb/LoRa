...
struct Radio_s
{
     ...
     * \param [IN] modem Modem to be used [0: FSK, 1: LoRa] 
     */
    void    ( *TxSetModem )( RadioModems_t modem );
    /*!
     ...
     * \param [IN] freq         Channel RF frequency
     */
    void    ( *TxSetChannel )( uint32_t freq );
    /*!
     ...
     * \param [IN]: data New register value
     */
    void    ( *TxWrite )( uint8_t addr, uint8_t data );
    /*!
     ...
     * \param [IN] size   Number of registers to be written
     */
    void    ( *TxWriteBuffer )( uint8_t addr, uint8_t *buffer, uint8_t size );
    /*!
     ...
     * \param [IN] size Number of registers to be read
     */
    void    ( *TxReadBuffer )( uint8_t addr, uint8_t *buffer, uint8_t size );
    /*!
     ...
     * \param [IN] max        Maximum payload length in bytes
     */
    void ( *TxSetMaxPayloadLength )( RadioModems_t modem, uint8_t max );
