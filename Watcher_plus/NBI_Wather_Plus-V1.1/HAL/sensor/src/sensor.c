...
void SamplingData(void)
{
    ...
    else if(lux>1700 && lux<188000) ///>1700 y = 0.0004 x2 + 0.4944 x + 2221.5533 
    {
        luxdata = (pow(lux,2) * 0.0004);
        luxdata += 0.4944 * lux + 2221.5533;
    }
    else if(lux>30 && lux<1700) ///<1700 y = -0.0005 x2 + 3.2066 x - 40.9392 
    {
        luxdata = (pow(lux,2) * -0.0005);
        luxdata += (3.2066 * lux) - 40.9392;
    }
    else 
    {
        luxdata = lux;
